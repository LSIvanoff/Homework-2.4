package Homeworks.Calculator.controller;


import Homeworks.Calculator.exception.DivideByZeroException;
import Homeworks.Calculator.exception.NullParameterException;
import Homeworks.Calculator.service.CalculatorService;
...
public String plus(@RequestParam(required = false) Integer num1, @RequestParam(required = false) Integer num2) {
    ...
    private void validateParams(Integer num1, Integer num2) {
        if (num1 == null || num2 == null) {
            throw new NullParameterException("Ошибка, не внесен параметр");
        }
    }
